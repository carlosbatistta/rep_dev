...
class ImportStockController {
    handle: RequestHandler = async (req: Request, res: Response) => {
        try {
            ...
            const { branch_code, storage_code, date_count, document } = req.body;
            ...
            const stock_imp = await importStockService.execute({ branch_code, storage_code, date_count, document });
